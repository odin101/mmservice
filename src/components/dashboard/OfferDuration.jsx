...
React.useEffect(() => {
  ...
  <div className="container flex flex-col">
    <div className="flex gap-4 items-center justify-evenly container">
      ...
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 flex items-center justify-center font-bold rounded-full border-2 bg-white/10 xs:w-8 xs:h-8 border-secondary text-secondary">5</div>
              ...
              <div data-v-c4972650 className="flex gap-4 mb-12 flex-wrap">
         {
            items.map((item,index) => {
                ...
                <div data-v-c4972650
                  ...
                  <div data-v-c4972650 className="flex items-center no-wrap gap-2">
                    <svg data-v-c4972650 className={selected==index?"circle active":"circle"}  width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle data-v-c4972650 cx={8} cy={8} r={7} stroke="white" strokeOpacity="0.28" strokeWidth={2} />
                    </svg>
                    <div data-v-c4972650 className={"flash-card flex justify-center items-center product-card cursor-pointer p-2"+(selected==index?" active":"")}>
                      <div data-v-c4972650 className="col text-center">
                        <div data-v-c4972650 className="label text-center font-bold text-subtitle1" style={{"letter-spacing":"1px"}}>{item}</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div data-v-c4972650 className="flex flex-col gap-2">
