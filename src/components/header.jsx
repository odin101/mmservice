...
const CloseChat = () => {
 ...
 const onSubmitReg = (username,email,password)  => {
 ...
 <>
  ...
  <div className="flex items-center gap-2" data-v-5315b842>
    <div  onClick={() => {
    setMobileSearch(true)
    }} className="flex items-center gap-1 hidden sm:block" data-v-5315b842>
          ...
          {/**/}
{
  notificaitons && (
    ...
    <div 
    className='sm:right-0 top-20 overflow-hidden rounded-lg notifi'
    style={{background:"rgb(42, 46, 60)",boxShadow:" rgba(0, 0, 0, 0.3) 0px 4px 34px", width:"400px", maxWidth:"80%", marginLeft: "-200px", position:" absolute !important"}}>
    <div data-overlayscrollbars-initialize data-overlayscrollbars="host">
      ...
      <div className="os-viewport os-viewport-scrollbar-hidden" style={{"margin-right":"0px","margin-bottom":"0px","margin-left":"0px","top":"0px","right":"auto","left":"0px","width":"calc(100% + 0px)","padding":"0px"}}>
        <div className="w-full px-4 py-3 flex items-center justify-between">
          <div className="font-bold">You do not have any notifications.</div>
        </div>
...

{
  ...
  <div className="px-6" style={{}}>
    <div className="flex items-center no-wrap gap-2" style={{}}>
      <img
                src={auth().profileImage?auth().profileImage:MissingImg }
       format="webp" loading="lazy" className="xs:hidden" style={{"width":"36px","height":"36px","border-radius":"100%","border":"3px solid rgba(255, 255, 255, 0.12)"}} />
      <div className="flex flex-col items-start">
        <div className="text-center text-white font-bold text-ellipsis overflow-hidden whitespace-nowrap" style={{"max-width":"150px"}}>                { 
                auth().username
                }</div>
      </div>
    </div>
  ...
  <div className="px-2">
    ...
    <div onClick={() => {
      Logout()
    }} className="flex items-center gap-3 py-3 cursor-pointer duration-300 rounded-lg px-4 hover:bg-white/5">
