...
export default class modal extends Component {
  ...
  render() {
    return (
     <>
    <div onClick={() => this.props.backClick()} className="g-dialog-overlay g-dialog-overlay--active" style={{"z-index":"1021","--6eaca59a":"var(--overlay-bg)"}} />
        <div className="g-dialog-frame g-dialog-frame--active" style={{"z-index":"1022"}}>
          <div className="g-dialog-content" style={{"max-width":"550px","--889a571a":"var(--content-bg)","--023a843a":"14px"}}>
            <div className="text-white" style={{"background":"rgb(31, 35, 50)"}}><div><div><div className="px-12 my-8 sm:px-6">
                      ...
                      <div
                       ...
                       data-v-1fb46fc5 data-v-5e610566-s className="btn text-center cursor-pointer w-full flex justify-center items-center gap-4" style={{"background":"rgb(255, 255, 255)"}}>
                        ...
                        <div className="hidden"><div id="appleid-signin" data-mode="logo-only" data-type="sign in" data-color="black" data-border="true" data-radius={15} data-width="100%" data-height="100%" data-logo-size="medium" data-logo-position={0} data-label-position={0} className="vue-apple-signin">
                          <div style={{"font-synthesis":"none","-moz-font-feature-settings":"kern","-webkit-font-smoothing":"antialiased","-moz-osx-font-smoothing":"grayscale","width":"100%","height":"100%","min-width":"30px","max-width":"64px","min-height":"30px","max-height":"64px","position":"relative"}} 
          ...
          <div style={{"padding":"1px","width":"100%","height":"100%","box-sizing":"border-box"}}>
            <svg xmlns="http://www.w3.org/2000/svg" style={{"overflow":"visible"}} width="100%" height="100%" viewBox="0 0 50 50" preserveAspectRatio="xMidYMin meet">
              <rect width="100%" height="100%" ry="15%" fill="#000" stroke="black" strokeWidth={1} strokeLinecap="round" /></svg></div>
